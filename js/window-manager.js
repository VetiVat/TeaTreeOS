...
export function open(appId, fileHandle = null) {
  ...
  if (fileHandle) {
    // Open media viewer with file handle
    ...
    const messageListener = (event) => {
      if (event.data.type === 'teatreeos-media-data') {
        win.querySelector('.media-viewer').innerHTML = event.data.content;
